...
import AddMilestoneModal from '../components/AddMilestoneModal.jsx';
import DepositModal from '../components/DepositModal.jsx';
import WithdrawModal from '../components/WithdrawModal.jsx'; // Import WithdrawModal
...
const ContractPage = () => {
  ...
  useEffect(() => {
    const fetchContract = async () => {
      try {
        const res = await axios.get(`/api/jobs/${id}`); // Corrected endpoint
